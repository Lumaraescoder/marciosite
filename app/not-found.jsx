...
export const metadata = {
  title: "Page Not Found || Golf colour tour - Travel & Tour",
  description:
    "Oops! The page you are looking for does not exist on Golf colour tour. Return to the homepage or explore our travel and tour services.",
};
